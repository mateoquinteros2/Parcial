...
/**
 *  El metodo Runge-Kutta es un algoritmo que aproxima soluciones de
 ...
 *  Runge-Kutta puede ser calculado con distintos ordenes. Mientras
 ...
 *  Donde: 
 *
 * F1 = h * f(x,y)  F2 = h * f(x+(1/2)*h, y+(1/2)*F1) F3 = h
 * * f(x+(1/2)*h, y+(1/2)*F2) F4 = h * f(x+h, y+F3) Se puede
 ...
 * la pendiente al principio del intervalo - F2 es la pendiente en el punto
 * medio del intervalo - F3 es otra vez la pendiente del punto medio, pero
 * ahora usando F2 para determinar el valor de y - F4 es la pendiente al
 * final del intervalo, con el valor de y determinado por F3 El error
